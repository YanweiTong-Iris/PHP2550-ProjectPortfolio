...
### The Impact of Environmental Fators on Marathon Performance
...
plots <- lapply(seq_along(factors), function(i) {
  ggplot(merged_main %>% filter(Age >= 15), 
    ...
    theme(
      ...
      axis.title.y = element_text(size = if (i == 1) 12 else 0),
      axis.text.y = element_text(size = if (i == 1) 10 else 0),
