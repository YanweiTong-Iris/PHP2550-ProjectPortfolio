...
This study investigated the predictors and moderators of smoking cessation outcomes among individuals with MDD, focusing on the effects of behavioral activation (BA). As shown in Figure 1, BA’s effectiveness varied significantly depending on baseline characteristics. For example, individuals with higher Nicotine Metabolism Ratio (NMR) and greater readiness to quit smoking were more likely to benefit from BA, while those with higher nicotine dependence, as measured by FTCD score, experienced reduced efficacy. Current versus past MDD status also influenced outcomes, indicating that addressing active depressive symptoms is crucial for maximizing the benefits of BA. These findings suggest that the success of behavioral interventions can be enhanced by tailoring treatment plans to individual characteristics.

Baseline predictors, summarized in Table 2, highlight the complex interplay of biological, socioeconomic, and demographic factors in determining smoking cessation outcomes. Higher NMR and greater readiness to quit were associated with increased odds of cessation, while higher FTCD scores were consistently associated with poorer outcomes. Educational attainment also played a role, with higher levels generally predicting better success rates. However, disparities in outcomes by race and ethnicity suggest the need for targeted efforts to address systemic inequities that may hinder access to cessation resources. As shown in Table 1 and Table 3, Elastic Net provided superior calibration, making it suitable for applications where accurate probability estimation is critical, while Lasso demonstrated slightly better discrimination, useful for distinguishing between individuals who quit smoking and those who did not.
